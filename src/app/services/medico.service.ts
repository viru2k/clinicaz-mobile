...
getHistoriaClinicaByPaciente(paciente_id:string,medico_id:string){
  return this.http.get<HistoriaClinica[]>(this.url_historia_clinica+'/historia?paciente_id='+paciente_id+'&medico_id='+medico_id); 
  }
